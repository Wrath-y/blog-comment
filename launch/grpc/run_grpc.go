...
import (
	...
	defgrpc "comment/infrastructure/util/def/grpc"
	"comment/infrastructure/util/logging"
	"comment/interfaces/proto"
	"comment/interfaces/proto/facade"
	middleware2 "comment/launch/grpc/middleware"
...
func RunGrpc() {
	...
	proto.RegisterCommentServer(grpcServer, &facade.Comment{})
